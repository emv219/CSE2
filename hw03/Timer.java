...
int timeRemaining = dinnerTime - currentTime;
int hoursRemaining = timeRemaining /100;
int minutesRemaining = timeRemaining - (100*hoursRemaining);

System.out.println("There are " + hoursRemaining + " hour(s) and " + minutesRemaining + " minutes until dinner");
    }
}
